...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-white dark:bg-background-dark text-gray-900 dark:text-gray-100 overflow-hidden font-sans relative">
      {/* Dynamic Background */}
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative z-10 w-full">
        ...
        {/* Mobile Header */}
        <div className="md:hidden flex items-center justify-between p-4 bg-white/80 dark:bg-black/40 backdrop-blur-md border-b border-gray-100 dark:border-white/5">
